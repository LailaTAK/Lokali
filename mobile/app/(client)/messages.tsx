// mobile/app/(client)/messages.tsx
...
/**
 * Chat Messaging Screen (Conversations index + details views).
 * Integrates real-time Socket.io events, unread badges, typing triggers, and auto-scrolled logs.
 */
          ...
          ListEmptyComponent={
            !isLoading ? (
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptySub}>Réservez un séjour pour commencer à discuter avec l'hôte.</Text>
              </View>
            ) : (
        ...
        <View style={styles.chatFooter}>
          {isTyping && (
            <View style={styles.typingIndicatorRow}>
              <Text style={styles.typingText}>L'interlocuteur écrit...</Text>
            </View>
          )}
